---
title: "AGEO PLAGAST_Clinical Final analysis 08172024"
...
ggsurvplot(KM_curve, data = circ_data, pval = FALSE, conf.int = FALSE, risk.table = TRUE, break.time.by=12, palette=c("blue","red"), title="DFS - ctDNA MTM/mL groups at Baseline", ylab= "Disease-Free Survival", xlab="Months from surgery", legend.labs=c("MTM/mL<1.085", "MTM/mL≥1.085"), legend.title="")
summary(KM_curve, times= c(24))
